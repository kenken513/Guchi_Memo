...
class _$_GuchiState with DiagnosticableTreeMixin implements _GuchiState {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'GuchiState'))
      ..add(DiagnosticsProperty('guchiList', guchiList));
  }
